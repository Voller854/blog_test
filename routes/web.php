...
Route::group(['namespace' => 'App\Http\Controllers\Personal', 'prefix' => 'personal','middleware'=>['auth','verified']], function () {
    ...
    Route::get('/liked', [App\Http\Controllers\Personal\Liked\IndexController::class, '__invoke'])->name('personal.liked.index');
    Route::delete('/liked/{post}', [App\Http\Controllers\Personal\Liked\DeleteController::class, '__invoke'])->name('personal.liked.delete');
    Route::get('/comment', [App\Http\Controllers\Personal\Comment\IndexController::class, '__invoke'])->name('personal.comment.index');
    Route::get('/comment/{comment}/edit', [App\Http\Controllers\Personal\Comment\EditController::class, '__invoke'])->name('personal.comment.edit');
    Route::patch('/comment/{comment}', [App\Http\Controllers\Personal\Comment\UpdateController::class, '__invoke'])->name('personal.comment.update');
    Route::delete('/comment/{comment}', [App\Http\Controllers\Personal\Comment\DeleteController::class, '__invoke'])->name('personal.comment.delete');
});
