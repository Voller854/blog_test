...
<head>
    ...
    <link rel="stylesheet" href="{{secure_asset('assets/vendors/font-awesome/css/all.min.css')}}">
    <link rel="stylesheet" href="{{secure_asset('assets/vendors/aos/aos.css')}}">
    <link rel="stylesheet" href="{{secure_asset('assets/css/style.css')}}">
    <script src="{{secure_asset('assets/vendors/jquery/jquery.min.js')}}"></script>
    <script src="{{secure_asset('assets/js/loader.js')}}"></script>
</head>
<body>
...
<header class="edica-header">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="index.html"><img src="{{secure_asset('assets/images/logo.svg')}}" alt="Edica"></a>
...
<script src="{{secure_asset('assets/vendors/popper.js/popper.min.js')}}"></script>
<script src="{{secure_asset('assets/vendors/bootstrap/dist/js/bootstrap.min.js')}}"></script>
<script src="{{secure_asset('assets/vendors/aos/aos.js')}}"></script>
